...
const AnswerPanel = ({ questionType, kanji, kanjiSvg, answerOptions, progress, mistakeCount }) => (
      ...
      <table>
        <tr>
          ...
          <td>
            ...
            <p>
              <button className="btn btn-xs btn-default">Skip</button>
              <small className="text-muted"> { ' if you are lazy' } </small>
            </p>
            <p>
              <button className="btn btn-xs btn-default">Mark as correct</button>
